...
Note: Some time try to open postman redirect to open the app via browser. if that issue happens then remove the postman
...
Each row represents a different entry in the table.
     Colums  Colums Colums Colums
ID     | name     |   Age | Sex
--------------------------------
14642  | Carl     | 40    | M     => Rows
...
Primary Key: najuvia@gmail.cvom
...
Semi Coloum at the end of the every SQL command
